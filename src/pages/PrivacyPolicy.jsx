  ...
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="May 13, 2026">
      ...
      <ul>
        ...
        <li>Email address</li>
        <li>Phone number</li>
        <li>Property or inquiry-related details</li>
      </ul>
      ...
      <ul>
        ...
        <li>Send updates related to your inquiry or services</li>
      ...
      <p>
        We do not sell, rent, or share your phone number or SMS consent information with third parties for marketing purposes.
      </p>
